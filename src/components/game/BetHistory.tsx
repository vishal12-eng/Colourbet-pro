...
const BetHistory = () => {
  ...
  return (
    <div className="glass rounded-2xl p-4 shadow-card">
      <h3 className="font-heading font-bold text-foreground text-base mb-3">My History</h3>
      {bets.length === 0 ? (
        <p className="text-xs text-muted-foreground text-center py-4">No bets yet. Place your first bet!</p>
      ) : (
